...
```{python}
import requests
college_key = "8HsvefqA3xeWyaCWa1Tay9AjIpamfcgM70ZlCg08"

college_link = f"https://api.data.gov/ed/collegescorecard/v1/schools?api_key={college_key}"

college_request = requests.get(college_link)

college_json = college_request.json()
